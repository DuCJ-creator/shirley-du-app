...
import { Strand, PointLog, UserData, StudyNote, PetData } from './types';
import { PET_TIERS, PET_TYPES, FOOD_TIERS, STRANDS } from './constants/petData';
import { GEMS, SUBJECT_GEMS } from './constants/gems';
import { hashString, getLocalDateString } from './lib/helpers';
import { UserAvatarCenter } from './components/UserAvatarCenter';
...
// --- GEMS & SUBJECT_GEMS imported from ./constants/gems ---
...
const NotePadLegacy = ({ notes, onSave, onDelete }: { notes: StudyNote[], onSave: (note: Partial<StudyNote>) => void, onDelete: (id: string) => void }) => {
        ...
        <div className="flex items-center justify-between gap-3 mb-2 shrink-0 bg-zinc-900/40 p-2 sm:p-2.5 rounded-xl sm:rounded-2xl border border-white/5 shadow-inner">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <button 
              ...
              className={cn(
                "flex items-center gap-1.5 transition-all px-2.5 py-1.5 rounded-xl border active:scale-95 select-none",
                isTrackerVisible 
